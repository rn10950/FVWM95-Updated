        ...
        case MSG_CLICK:
          switch (wmsg->id) {
            ...
            case M_VIEW_WIREFRAME:
              _glView->Wireframe(tb_data[14].button->GetState() != BUTTON_UP);
              break;
...
void MainFrame::SetWindowTitle(char *title) {
  static char *pname = "OpenGL test application";
...
void MainFrame::DoAbout() {
  ...
  info.copyright = "Copyright © 1998-2006 by the fOX Project Team.";
