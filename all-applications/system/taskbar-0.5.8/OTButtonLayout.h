...
#ifndef __OTBUTTONLAYOUT_H
#define __OTBUTTONLAYOUT_H
...
class OTButtonLayout : public OLayoutManager {
public:
  OTButtonLayout(class OXCompositeFrame *main,
                 int rowh = 22, int rows = 1, int sep = 2);
