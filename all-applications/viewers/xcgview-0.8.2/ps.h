...
#define URY 3
	...
	/* PS_NONE is not a keyword, it tells when a field was not set */
...
#define PS_LINELENGTH 257	/* 255 characters + 1 newline + 1 NULL */

struct document {
    int  epsf;				/* Encapsulated PostScript flag. */
    char *title;			/* Title of document. */
    char *date;				/* Creation date. */
    int  pageorder;			/* PS_ASCEND, PS_DESCEND, PS_SPECIAL */
    ...
    int  orientation;			/* PS_PORTRAIT, PS_LANDSCAPE */
    int  default_page_orientation;	/* PS_PORTRAIT, PS_LANDSCAPE */
